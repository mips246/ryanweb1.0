      ...
      <div class="fl">
        ...
        <div class="item">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">数字逻辑理论</a>
            <a class="dropdown-item" href="#">数字逻辑实验</a>
            <a class="dropdown-item" href="#">计算机组成原理理论</a>
            <a class="dropdown-item" href="#">计算机组成原理实验</a>
            <a class="dropdown-item" href="#">计算机体系结构理论</a>
            <a class="dropdown-item" href="#">计算机体系结构实验</a>
          </div>
        </div>
        <div class="item">
          <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">课程资料</button>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">数字逻辑</a>
            <a class="dropdown-item" href="#">计算机组成原理</a>
            <a class="dropdown-item" href="#">计算机体系结构</a>
          </div>
        </div>
        <div class="item">
